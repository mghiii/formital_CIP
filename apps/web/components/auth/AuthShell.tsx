...
export function AuthShell({ children }: PropsWithChildren) {
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7faf7] px-5 py-6 text-ink">
      <div className="fixed right-5 top-5 z-30">
        <ThemeToggle />
      </div>
      <section className="mx-auto grid min-h-[calc(100vh-3rem)] w-full max-w-7xl items-center gap-8 rounded-[1.5rem] border border-formital-green/20 bg-white/90 p-5 shadow-soft lg:grid-cols-[1fr_0.92fr] lg:p-10">
        <div className="relative flex min-h-[680px] overflow-hidden rounded-2xl bg-white p-8 dark:bg-[#0b1711]">
        ...
        <div className="flex items-center justify-center">
          <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-8 shadow-soft">
